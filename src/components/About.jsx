...
const About = () => {
  return (
    <section id="about" className="relative w-full px-6 md:px-20 py-24 md:py-32 flex flex-col md:flex-row items-center gap-14 md:gap-20 bg-white text-primary overflow-hidden">
