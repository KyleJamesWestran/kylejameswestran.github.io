...
const About = () => {
  return (
    <div id="ABOUT" className="default-content text-base pt-20 p-6">
      <h2 className="text-2xl mb-4 font-semibold">Who I Am</h2> 
      ...
      <p className="mb-5 text-secondary">
        So if you see the potential for collaberation, feel free to <strong>reach out</strong>.
      </p>
    </div>
  );
};
